...
try:
    ...
    izip = zip
# from detection.mxnet_mtcnn_face_detection import helper
...
class MtcnnDetector(object):
    ...
    def detect_face(self, img):
        ...
        for batch in sliced_index:
            ...
            local_boxes=[]
            for args in izip(repeat(img), self.PNets[:len(batch)], [scales[i] for i in batch], repeat(self.threshold[0])):
                local_boxes.append(detect_first_stage_warpper(args))
